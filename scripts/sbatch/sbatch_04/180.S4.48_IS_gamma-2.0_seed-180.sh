...
python train_nli.py \
  --seed 180 \
  --dataset SNLI \
  --outputmodelname 'S4.48_IS_ds-SNLI_gamma-2.0_seed-180' \
  --outputdir /scratch/izar/rajic/nli/logs/infersent/dataset-SNLI_gamma-2.0_seed-180/ \
  --outputfile /scratch/izar/rajic/nli/logs/infersent/dataset-SNLI_gamma-2.0_seed-180.csv \
