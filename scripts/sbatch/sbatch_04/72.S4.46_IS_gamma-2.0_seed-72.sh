...
python train_nli.py \
  --seed 72 \
  --dataset SNLI \
  --outputmodelname 'S4.46_IS_ds-SNLI_gamma-2.0_seed-72' \
  --outputdir /scratch/izar/rajic/nli/logs/infersent/dataset-SNLI_gamma-2.0_seed-72/ \
  --outputfile /scratch/izar/rajic/nli/logs/infersent/dataset-SNLI_gamma-2.0_seed-72.csv \
